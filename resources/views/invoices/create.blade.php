                    ...
                    <form method="POST" action="{{ route('invoices.store') }}" x-data="invoiceForm()">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                            ...
                            <div>
                                ...
                                <select id="payment_terms" name="payment_terms" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                    ...
                                    @foreach($paymentTerms as $value => $label)
                                        <option value="{{ $value }}" {{ old('payment_terms', auth()->user()->company->default_payment_terms) == $value ? 'selected' : '' }}>
                                            {{ $label }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div>
                                ...
                                <x-text-input id="tax_rate" class="block mt-1 w-full" type="number" name="tax_rate" :value="old('tax_rate', '0')" min="0" max="100" step="0.01" x-model="taxRate" />
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="notes" name="notes" rows="3" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Additional notes for the client...">{{ old('notes') }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="terms" name="terms" rows="3" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Terms and conditions...">{{ old('terms') }}</textarea>
